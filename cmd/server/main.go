...
func main() {
	args := Args{
		...
		Customs: []api.Column{
			...
			{ID: 38, Type: "string", Name: "STR06"},
			{ID: 39, Type: "string", Name: "STR07"},
			{ID: 40, Type: "string", Name: "STR08"},
			{ID: 41, Type: "string", Name: "STR09"},
			{ID: 42, Type: "string", Name: "STR10"},
			{ID: 43, Type: "string", Name: "STR11"},
			{ID: 44, Type: "string", Name: "STR12"},
			{ID: 45, Type: "string", Name: "STR13"},
			{ID: 46, Type: "string", Name: "STR14"},
			{ID: 47, Type: "string", Name: "STR15"},
			{ID: 48, Type: "string", Name: "STR16"},
			{ID: 49, Type: "string", Name: "STR17"},
			{ID: 50, Type: "string", Name: "STR18"},
			{ID: 51, Type: "string", Name: "STR19"},
			{ID: 52, Type: "string", Name: "STR20"},
			{ID: 53, Type: "inet", Name: "INET_00"},
			{ID: 54, Type: "inet", Name: "INET_01"},
			{ID: 55, Type: "inet", Name: "INET_02"},
		},
	}
