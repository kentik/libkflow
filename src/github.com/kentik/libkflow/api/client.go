...
func (c *Client) CreateDeviceByIPAndName(ip net.IP, name string, sampleRate int, deviceType string, planId int) (*Device, error) {
	return c.createdevice(ip, name, sampleRate, deviceType, planId)
}
...
func (c *Client) createdevice(ip net.IP, name string, sampleRate int, deviceType string, planId int) (*Device, error) {
