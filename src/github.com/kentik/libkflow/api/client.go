...
func (c *Client) CreateDeviceByIPAndName(ip net.IP, name string, sampleRate int, deviceType string, planId int) (*Device, error) {
	if err := c.createdevice(c.deviceURL, ip, name, sampleRate, deviceType, planId); err != nil {
		return nil, err
	}
	return c.getdevice(fmt.Sprintf(c.deviceURL, ip))
}
...
func (c *Client) createdevice(url string, ip net.IP, name string, sampleRate int, deviceType string, planId int) error {
	payload := CreateDeviceRequest{
		DeviceName:        name,
		DeviceType:        deviceType,
		DeviceDescription: "autogenerated " + name,
		PlanId:            planId,
		DeviceSampleRate:  sampleRate,
		SendingIps:        []string{ip.String()},
	}
